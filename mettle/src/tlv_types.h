 ...
 * Memory
 */
#define TLV_TYPE_MEM_SEARCH_NEEDLE     (TLV_META_TYPE_STRING   | 2650)
#define TLV_TYPE_MEM_SEARCH_RESULTS    (TLV_META_TYPE_GROUP    | 2651)
#define TLV_TYPE_MEM_SEARCH_MATCH_LEN  (TLV_META_TYPE_UINT     | 2652)
#define TLV_TYPE_MEM_SEARCH_START_ADDR (TLV_META_TYPE_QWORD    | 2653)
#define TLV_TYPE_MEM_SEARCH_END_ADDR   (TLV_META_TYPE_QWORD    | 2654)
#define TLV_TYPE_MEM_SEARCH_MATCH_ADDR (TLV_META_TYPE_QWORD    | 2655)
