...
#define TLV_TYPE_MIGRATE_PAYLOAD       (TLV_META_TYPE_RAW     | 404)
#define TLV_TYPE_MIGRATE_ARCH          (TLV_META_TYPE_UINT    | 405)
#define TLV_TYPE_MIGRATE_STUB          (TLV_META_TYPE_RAW     | 411)
